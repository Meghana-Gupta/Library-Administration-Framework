   ...
   // String s[]={"Select ","maths","tamil"}; 
    ...
    Status(){
         ...
         /*  jb=new JComboBox();
           ...
           add(next);
         /*  next=new JLabel("Category");
           next.setBounds(470,390,200,40);
           next.setFont(new Font("serif",Font.BOLD,30));
           add(next);*/
           t3=new JTextField();
    ...
    public void checking()
    {
     ...
     try{  
          ...
          PreparedStatement ps = conn.prepareStatement("select bookid,bookname,edition,author,availablity from book where bookname=? or author=? or bid=?");
          ps.setString(1, str1);
          ps.setString(2, str2);
          ps.setInt(3, ent);
