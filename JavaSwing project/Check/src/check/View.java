...
public class View extends JFrame implements ActionListener{
    ...
    public void checking()
    {
     ...
     try{  
          ...
          Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","system","kannan03");
          ...
          PreparedStatement ps = conn.prepareStatement("select bid,bname,edition,author,location,availablity from book where Bname=? or author=? or edition=?");
          ps.setString(1, str1);
          ps.setString(2, str2);
          ps.setInt(3, ent);
          ...
          while(rs.next()){
              ...
              JLabel h=new JLabel("LOCATION");
              h.setBounds(825,80,200,30);
              h.setFont(new Font("serif",Font.BOLD,30));
              a.add(h);
              h=new JLabel("AVAILABILITY");
              h.setBounds(1000,80,250,30);
              h.setFont(new Font("serif",Font.BOLD,30));
              a.add(h);
              JLabel e=new JLabel();
